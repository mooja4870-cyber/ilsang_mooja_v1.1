...
public final class DropWhileSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        private T nextItem;
        final /* synthetic */ kotlin.sequences.DropWhileSequence<T> this$0;

        AnonymousClass1(kotlin.sequences.DropWhileSequence<T> r2) {
                r1 = this;
                r1.this$0 = r2
                r1.<init>()
                kotlin.sequences.Sequence r0 = kotlin.sequences.DropWhileSequence.access$getSequence$p(r2)
        ...
        private final void drop() {
            ...
            L1:
                ...
                kotlin.sequences.DropWhileSequence<T> r1 = r2.this$0
        ...
        public final void setDropState(int r1) {
                r0 = this;
                r0.dropState = r1
                return
        }
    ...
    public DropWhileSequence(kotlin.sequences.Sequence<? extends T> r2, kotlin.jvm.functions.Function1<? super T, java.lang.Boolean> r3) {
            r1 = this;
    ...
    public static final /* synthetic */ kotlin.jvm.functions.Function1 access$getPredicate$p(kotlin.sequences.DropWhileSequence r1) {
            kotlin.jvm.functions.Function1<T, java.lang.Boolean> r0 = r1.predicate
            return r0
    }

    public static final /* synthetic */ kotlin.sequences.Sequence access$getSequence$p(kotlin.sequences.DropWhileSequence r1) {
    ...
    public java.util.Iterator<T> iterator() {
            r1 = this;
            kotlin.sequences.DropWhileSequence$iterator$1 r0 = new kotlin.sequences.DropWhileSequence$iterator$1
            r0.<init>(r1)
