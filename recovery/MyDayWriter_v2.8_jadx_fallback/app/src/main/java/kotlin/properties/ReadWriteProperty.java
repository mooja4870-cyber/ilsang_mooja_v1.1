...
public interface ReadWriteProperty<T, V> extends kotlin.properties.ReadOnlyProperty<T, V> {
    @Override // kotlin.properties.ReadOnlyProperty
    V getValue(T r1, kotlin.reflect.KProperty<?> r2);

    void setValue(T r1, kotlin.reflect.KProperty<?> r2, V r3);
}
