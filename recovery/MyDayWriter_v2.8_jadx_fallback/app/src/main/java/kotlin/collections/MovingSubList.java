...
public final class MovingSubList<E> extends kotlin.collections.AbstractList<E> implements java.util.RandomAccess {
    ...
    public MovingSubList(java.util.List<? extends E> r2) {
            r1 = this;
    ...
    public final void move(int r3, int r4) {
            r2 = this;
            kotlin.collections.AbstractList$Companion r0 = kotlin.collections.AbstractList.Companion
            java.util.List<E> r1 = r2.list
            int r1 = r1.size()
            r0.checkRangeIndexes$kotlin_stdlib(r3, r4, r1)
            r2.fromIndex = r3
            int r0 = r4 - r3
            r2._size = r0
            return
