...
public final class UByteKt {
    private static final byte toUByte(byte r1) {
            byte r0 = kotlin.UByte.m171constructorimpl(r1)
            return r0
    }

    private static final byte toUByte(int r1) {
            byte r0 = (byte) r1
            byte r0 = kotlin.UByte.m171constructorimpl(r0)
            return r0
    }

    private static final byte toUByte(long r1) {
            int r0 = (int) r1
            byte r0 = (byte) r0
            byte r0 = kotlin.UByte.m171constructorimpl(r0)
            return r0
    ...
    private static final byte toUByte(short r1) {
            byte r0 = (byte) r1
            byte r0 = kotlin.UByte.m171constructorimpl(r0)
            return r0
    }
