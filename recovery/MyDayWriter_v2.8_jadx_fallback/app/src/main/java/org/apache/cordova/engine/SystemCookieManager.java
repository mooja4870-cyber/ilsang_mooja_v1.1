...
class SystemCookieManager implements org.apache.cordova.ICordovaCookieManager {
    private final android.webkit.CookieManager cookieManager;
    protected final android.webkit.WebView webView;

    public SystemCookieManager(android.webkit.WebView r4) {
            r3 = this;
            r3.<init>()
            r3.webView = r4
    ...
    public void setAcceptFileSchemeCookies() {
            r1 = this;
            r0 = 1
            android.webkit.CookieManager.setAcceptFileSchemeCookies(r0)
            return
    }
