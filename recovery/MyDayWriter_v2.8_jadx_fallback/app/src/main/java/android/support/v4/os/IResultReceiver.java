...
public interface IResultReceiver extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements android.support.v4.os.IResultReceiver {
        ...
        private static class Proxy implements android.support.v4.os.IResultReceiver {
            ...
            public java.lang.String getInterfaceDescriptor() {
                    r1 = this;
                    java.lang.String r0 = android.support.v4.os.IResultReceiver.Stub.Proxy.DESCRIPTOR
                    return r0
            }
            ...
            public void send(int r5, android.os.Bundle r6) throws android.os.RemoteException {
                    ...
                    java.lang.String r1 = android.support.v4.os.IResultReceiver.Stub.Proxy.DESCRIPTOR     // Catch: java.lang.Throwable -> L1c
                    r0.writeInterfaceToken(r1)     // Catch: java.lang.Throwable -> L1c
                    r0.writeInt(r5)     // Catch: java.lang.Throwable -> L1c
                    r1 = 0
                    android.support.v4.os.IResultReceiver._Parcel.access$100(r0, r6, r1)     // Catch: java.lang.Throwable -> L1c
        ...
        public Stub() {
                r1 = this;
                r1.<init>()
                java.lang.String r0 = android.support.v4.os.IResultReceiver.Stub.DESCRIPTOR
        ...
        public static android.support.v4.os.IResultReceiver asInterface(android.os.IBinder r2) {
            ...
            L4:
                ...
                if (r1 == 0) goto L14
                r1 = r0
                android.support.v4.os.IResultReceiver r1 = (android.support.v4.os.IResultReceiver) r1
                return r1
            L14:
                android.support.v4.os.IResultReceiver$Stub$Proxy r1 = new android.support.v4.os.IResultReceiver$Stub$Proxy
                r1.<init>(r2)
                return r1
        }
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) throws android.os.RemoteException {
            ...
            L1e:
                ...
                java.lang.Object r3 = android.support.v4.os.IResultReceiver._Parcel.access$000(r6, r3)
    ...
    static {
            ...
            android.support.v4.os.IResultReceiver.DESCRIPTOR = r0
            return
    }
