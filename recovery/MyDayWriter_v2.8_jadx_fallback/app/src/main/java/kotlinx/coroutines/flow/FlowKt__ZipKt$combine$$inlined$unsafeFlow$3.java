...
public final class FlowKt__ZipKt$combine$$inlined$unsafeFlow$3<R> implements kotlinx.coroutines.flow.Flow<R> {
    ...
    public FlowKt__ZipKt$combine$$inlined$unsafeFlow$3(kotlinx.coroutines.flow.Flow[] r1, kotlin.jvm.functions.Function2 r2) {
            r0 = this;
            r0.$flowArray$inlined = r1
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super R> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
            ...
            r1 = r10
            r2 = 0
            kotlinx.coroutines.flow.Flow[] r3 = r8.$flowArray$inlined
            kotlin.jvm.internal.Intrinsics.needClassReification()
            kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$1 r4 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$1
            kotlinx.coroutines.flow.Flow[] r5 = r8.$flowArray$inlined
            r4.<init>(r5)
            kotlin.jvm.functions.Function0 r4 = (kotlin.jvm.functions.Function0) r4
            kotlin.jvm.internal.Intrinsics.needClassReification()
            kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2 r5 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2
    ...
    public java.lang.Object collect$$forInline(kotlinx.coroutines.flow.FlowCollector r9, kotlin.coroutines.Continuation r10) {
            r8 = this;
            kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$1 r0 = new kotlinx.coroutines.flow.FlowKt__ZipKt$combine$$inlined$unsafeFlow$3$1
            r0.<init>(r8, r10)
            r0 = r9
            r1 = r10
            r2 = 0
