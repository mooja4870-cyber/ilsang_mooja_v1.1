...
final class FlowKt__TransformKt$runningFold$1$1<T> implements kotlinx.coroutines.flow.FlowCollector {
    ...
    FlowKt__TransformKt$runningFold$1$1(kotlin.jvm.internal.Ref.ObjectRef<R> r1, kotlin.jvm.functions.Function3<? super R, ? super T, ? super kotlin.coroutines.Continuation<? super R>, ? extends java.lang.Object> r2, kotlinx.coroutines.flow.FlowCollector<? super R> r3) {
            r0 = this;
            r0.$accumulator = r1
            r0.$operation = r2
