...
final class SharingConfig<T> {
    ...
    public SharingConfig(kotlinx.coroutines.flow.Flow<? extends T> r1, int r2, kotlinx.coroutines.channels.BufferOverflow r3, kotlin.coroutines.CoroutineContext r4) {
            r0 = this;
            r0.<init>()
            r0.upstream = r1
            r0.extraBufferCapacity = r2
