...
public interface ChildJob extends kotlinx.coroutines.Job {
    ...
    public static final class DefaultImpls {
        ...
        public static /* synthetic */ void cancel(kotlinx.coroutines.ChildJob r1) {
                r0 = r1
        ...
        public static <R> R fold(kotlinx.coroutines.ChildJob r1, R r2, kotlin.jvm.functions.Function2<? super R, ? super kotlin.coroutines.CoroutineContext.Element, ? extends R> r3) {
                r0 = r1
                kotlinx.coroutines.Job r0 = (kotlinx.coroutines.Job) r0
        ...
        public static <E extends kotlin.coroutines.CoroutineContext.Element> E get(kotlinx.coroutines.ChildJob r1, kotlin.coroutines.CoroutineContext.Key<E> r2) {
                r0 = r1
                kotlinx.coroutines.Job r0 = (kotlinx.coroutines.Job) r0
        ...
        public static kotlin.coroutines.CoroutineContext minusKey(kotlinx.coroutines.ChildJob r1, kotlin.coroutines.CoroutineContext.Key<?> r2) {
                r0 = r1
                kotlinx.coroutines.Job r0 = (kotlinx.coroutines.Job) r0
        ...
        public static kotlin.coroutines.CoroutineContext plus(kotlinx.coroutines.ChildJob r1, kotlin.coroutines.CoroutineContext r2) {
                r0 = r1
                kotlinx.coroutines.Job r0 = (kotlinx.coroutines.Job) r0
        ...
        public static kotlinx.coroutines.Job plus(kotlinx.coroutines.ChildJob r1, kotlinx.coroutines.Job r2) {
                r0 = r1
                kotlinx.coroutines.Job r0 = (kotlinx.coroutines.Job) r0
