...
public final class Concurrent_commonKt {
    public static final <T> T getValue(java.util.concurrent.atomic.AtomicReference<T> r1) {
            java.lang.Object r0 = r1.get()
            return r0
    }

    public static /* synthetic */ void getValue$annotations(java.util.concurrent.atomic.AtomicReference r0) {
            return
    }

    public static final <T> void loop(java.util.concurrent.atomic.AtomicReference<T> r2, kotlin.jvm.functions.Function2<? super java.util.concurrent.atomic.AtomicReference<T>, ? super T, kotlin.Unit> r3) {
            r0 = 0
        L1:
            java.lang.Object r1 = getValue(r2)
            r3.invoke(r2, r1)
            goto L1
    }

    public static final <T> void setValue(java.util.concurrent.atomic.AtomicReference<T> r0, T r1) {
            r0.set(r1)
            return
    }
}
