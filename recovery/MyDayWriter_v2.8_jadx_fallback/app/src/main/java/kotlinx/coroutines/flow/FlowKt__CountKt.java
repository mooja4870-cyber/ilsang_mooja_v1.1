...
final /* synthetic */ class FlowKt__CountKt {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {13}, m = "count", n = {"i"}, s = {"L$0"})
    static final class AnonymousClass1<T> extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        java.lang.Object L$0;
        int label;
        /* synthetic */ java.lang.Object result;

        AnonymousClass1(kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.FlowKt__CountKt.AnonymousClass1> r1) {
                r0 = this;
                r0.<init>(r1)
                return
        }
    ...
    /* JADX INFO: compiled from: Count.kt */
    @kotlin.Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__CountKt", f = "Count.kt", i = {0}, l = {25}, m = "count", n = {"i"}, s = {"L$0"})
    static final class AnonymousClass3<T> extends kotlin.coroutines.jvm.internal.ContinuationImpl {
        java.lang.Object L$0;
        int label;
        /* synthetic */ java.lang.Object result;

        AnonymousClass3(kotlin.coroutines.Continuation<? super kotlinx.coroutines.flow.FlowKt__CountKt.AnonymousClass3> r1) {
                r0 = this;
                r0.<init>(r1)
                return
        }
    ...
    static final class AnonymousClass4<T> implements kotlinx.coroutines.flow.FlowCollector {
        ...
        AnonymousClass4(kotlin.jvm.functions.Function2<? super T, ? super kotlin.coroutines.Continuation<? super java.lang.Boolean>, ? extends java.lang.Object> r1, kotlin.jvm.internal.Ref.IntRef r2) {
                r0 = this;
                r0.$predicate = r1
                r0.$i = r2
                r0.<init>()
