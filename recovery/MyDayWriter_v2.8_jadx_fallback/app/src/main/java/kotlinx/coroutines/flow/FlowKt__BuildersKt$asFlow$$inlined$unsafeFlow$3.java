...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3<T> implements kotlinx.coroutines.flow.Flow<T> {
    ...
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$3", f = "Builders.kt", i = {0}, l = {114}, m = "collect", n = {"$this$asFlow_u24lambda_u243"}, s = {"L$0"})
