...
class EcdsaVerifyKeyManager extends com.google.crypto.tink.internal.KeyTypeManager<com.google.crypto.tink.proto.EcdsaPublicKey> {


    public EcdsaVerifyKeyManager() {
            r4 = this;
            java.lang.Class<com.google.crypto.tink.proto.EcdsaPublicKey> r0 = com.google.crypto.tink.proto.EcdsaPublicKey.class
            r1 = 1
            com.google.crypto.tink.internal.PrimitiveFactory[] r1 = new com.google.crypto.tink.internal.PrimitiveFactory[r1]
            com.google.crypto.tink.signature.EcdsaVerifyKeyManager$1 r2 = new com.google.crypto.tink.signature.EcdsaVerifyKeyManager$1
    ...
    @Override // com.google.crypto.tink.internal.KeyTypeManager
    public com.google.crypto.tink.proto.EcdsaPublicKey parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r2) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            r1 = this;
            ...
            com.google.crypto.tink.proto.EcdsaPublicKey r0 = com.google.crypto.tink.proto.EcdsaPublicKey.parseFrom(r2, r0)
            return r0
    }
    ...
    public /* bridge */ /* synthetic */ com.google.crypto.tink.shaded.protobuf.MessageLite parseKey(com.google.crypto.tink.shaded.protobuf.ByteString r1) throws com.google.crypto.tink.shaded.protobuf.InvalidProtocolBufferException {
            r0 = this;
            com.google.crypto.tink.proto.EcdsaPublicKey r1 = r0.parseKey(r1)
            return r1
    }

    public void validateKey(com.google.crypto.tink.proto.EcdsaPublicKey r3) throws java.security.GeneralSecurityException {
            r2 = this;
            int r0 = r3.getVersion()
            int r1 = r2.getVersion()
            com.google.crypto.tink.subtle.Validators.validateVersion(r0, r1)
            com.google.crypto.tink.proto.EcdsaParams r0 = r3.getParams()
