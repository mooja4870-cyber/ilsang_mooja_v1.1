...
public final class HmacKey extends com.google.crypto.tink.mac.MacKey {
    ...
    /* JADX INFO: renamed from: com.google.crypto.tink.mac.HmacKey$1, reason: invalid class name */
    ...
    public static class Builder {
        ...
        /* synthetic */ Builder(com.google.crypto.tink.mac.HmacKey.AnonymousClass1 r1) {
                r0 = this;
                r0.<init>()
                return
        }
        ...
        private com.google.crypto.tink.util.Bytes getOutputPrefix() {
                r4 = this;
                com.google.crypto.tink.mac.HmacParameters r0 = r4.parameters
            ...
            L4e:
                ...
                com.google.crypto.tink.mac.HmacParameters r2 = r4.parameters
        ...
        public com.google.crypto.tink.mac.HmacKey build() throws java.security.GeneralSecurityException {
                r8 = this;
                com.google.crypto.tink.mac.HmacParameters r0 = r8.parameters
                if (r0 == 0) goto L59
            ...
            L40:
                ...
                com.google.crypto.tink.mac.HmacKey r2 = new com.google.crypto.tink.mac.HmacKey
                com.google.crypto.tink.mac.HmacParameters r3 = r8.parameters
        ...
        public com.google.crypto.tink.mac.HmacKey.Builder setIdRequirement(@javax.annotation.Nullable java.lang.Integer r1) {
                r0 = this;
                r0.idRequirement = r1
                return r0
        }

        public com.google.crypto.tink.mac.HmacKey.Builder setKeyBytes(com.google.crypto.tink.util.SecretBytes r1) {
                r0 = this;
                r0.keyBytes = r1
                return r0
        }

        public com.google.crypto.tink.mac.HmacKey.Builder setParameters(com.google.crypto.tink.mac.HmacParameters r1) {
                r0 = this;
                r0.parameters = r1
                return r0
        }
    ...
    private HmacKey(com.google.crypto.tink.mac.HmacParameters r1, com.google.crypto.tink.util.SecretBytes r2, com.google.crypto.tink.util.Bytes r3, @javax.annotation.Nullable java.lang.Integer r4) {
            r0 = this;
            r0.<init>()
            r0.parameters = r1
            r0.keyBytes = r2
    ...
    /* synthetic */ HmacKey(com.google.crypto.tink.mac.HmacParameters r1, com.google.crypto.tink.util.SecretBytes r2, com.google.crypto.tink.util.Bytes r3, java.lang.Integer r4, com.google.crypto.tink.mac.HmacKey.AnonymousClass1 r5) {
            r0 = this;
            r0.<init>(r1, r2, r3, r4)
            return
    }
    ...
    public static com.google.crypto.tink.mac.HmacKey.Builder builder() {
            com.google.crypto.tink.mac.HmacKey$Builder r0 = new com.google.crypto.tink.mac.HmacKey$Builder
            r1 = 0
            r0.<init>(r1)
            return r0
    }
    ...
    public boolean equalsKey(com.google.crypto.tink.Key r5) {
            r4 = this;
            boolean r0 = r5 instanceof com.google.crypto.tink.mac.HmacKey
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            r0 = r5
            com.google.crypto.tink.mac.HmacKey r0 = (com.google.crypto.tink.mac.HmacKey) r0
            com.google.crypto.tink.mac.HmacParameters r2 = r0.parameters
            com.google.crypto.tink.mac.HmacParameters r3 = r4.parameters
    ...
    public /* bridge */ /* synthetic */ com.google.crypto.tink.Parameters getParameters() {
            r1 = this;
            com.google.crypto.tink.mac.HmacParameters r0 = r1.getParameters()
            return r0
    }

    @Override // com.google.crypto.tink.mac.MacKey, com.google.crypto.tink.Key
    public com.google.crypto.tink.mac.HmacParameters getParameters() {
            r1 = this;
            com.google.crypto.tink.mac.HmacParameters r0 = r1.parameters
            return r0
    }
