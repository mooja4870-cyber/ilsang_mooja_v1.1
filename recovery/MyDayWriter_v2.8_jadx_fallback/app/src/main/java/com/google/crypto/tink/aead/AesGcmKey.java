...
public final class AesGcmKey extends com.google.crypto.tink.aead.AeadKey {
    ...
    /* JADX INFO: renamed from: com.google.crypto.tink.aead.AesGcmKey$1, reason: invalid class name */
    ...
    public static class Builder {
        ...
        /* synthetic */ Builder(com.google.crypto.tink.aead.AesGcmKey.AnonymousClass1 r1) {
                r0 = this;
                r0.<init>()
                return
        }
        ...
        private com.google.crypto.tink.util.Bytes getOutputPrefix() {
                r4 = this;
                com.google.crypto.tink.aead.AesGcmParameters r0 = r4.parameters
                com.google.crypto.tink.aead.AesGcmParameters$Variant r0 = r0.getVariant()
            ...
            L12:
                com.google.crypto.tink.aead.AesGcmParameters r0 = r4.parameters
                com.google.crypto.tink.aead.AesGcmParameters$Variant r0 = r0.getVariant()
                com.google.crypto.tink.aead.AesGcmParameters$Variant r1 = com.google.crypto.tink.aead.AesGcmParameters.Variant.CRUNCHY
                r3 = 5
                if (r0 != r1) goto L38
            ...
            L38:
                com.google.crypto.tink.aead.AesGcmParameters r0 = r4.parameters
                com.google.crypto.tink.aead.AesGcmParameters$Variant r0 = r0.getVariant()
                com.google.crypto.tink.aead.AesGcmParameters$Variant r1 = com.google.crypto.tink.aead.AesGcmParameters.Variant.TINK
                if (r0 != r1) goto L5e
                java.nio.ByteBuffer r0 = java.nio.ByteBuffer.allocate(r3)
                r1 = 1
            ...
            L5e:
                ...
                r1.<init>()
                java.lang.String r2 = "Unknown AesGcmParameters.Variant: "
                java.lang.StringBuilder r1 = r1.append(r2)
                com.google.crypto.tink.aead.AesGcmParameters r2 = r4.parameters
        ...
        public com.google.crypto.tink.aead.AesGcmKey build() throws java.security.GeneralSecurityException {
                r8 = this;
                com.google.crypto.tink.aead.AesGcmParameters r0 = r8.parameters
                if (r0 == 0) goto L59
            ...
            L40:
                ...
                com.google.crypto.tink.aead.AesGcmKey r2 = new com.google.crypto.tink.aead.AesGcmKey
                com.google.crypto.tink.aead.AesGcmParameters r3 = r8.parameters
        ...
        public com.google.crypto.tink.aead.AesGcmKey.Builder setIdRequirement(@javax.annotation.Nullable java.lang.Integer r1) {
                r0 = this;
                r0.idRequirement = r1
                return r0
        }

        public com.google.crypto.tink.aead.AesGcmKey.Builder setKeyBytes(com.google.crypto.tink.util.SecretBytes r1) {
                r0 = this;
                r0.keyBytes = r1
                return r0
        }

        public com.google.crypto.tink.aead.AesGcmKey.Builder setParameters(com.google.crypto.tink.aead.AesGcmParameters r1) {
                r0 = this;
                r0.parameters = r1
                return r0
        }
    ...
    private AesGcmKey(com.google.crypto.tink.aead.AesGcmParameters r1, com.google.crypto.tink.util.SecretBytes r2, com.google.crypto.tink.util.Bytes r3, @javax.annotation.Nullable java.lang.Integer r4) {
            r0 = this;
            r0.<init>()
            r0.parameters = r1
            r0.keyBytes = r2
    ...
    /* synthetic */ AesGcmKey(com.google.crypto.tink.aead.AesGcmParameters r1, com.google.crypto.tink.util.SecretBytes r2, com.google.crypto.tink.util.Bytes r3, java.lang.Integer r4, com.google.crypto.tink.aead.AesGcmKey.AnonymousClass1 r5) {
            r0 = this;
            r0.<init>(r1, r2, r3, r4)
            return
    }
    ...
    public static com.google.crypto.tink.aead.AesGcmKey.Builder builder() {
            com.google.crypto.tink.aead.AesGcmKey$Builder r0 = new com.google.crypto.tink.aead.AesGcmKey$Builder
            r1 = 0
            r0.<init>(r1)
            return r0
    }
    ...
    public boolean equalsKey(com.google.crypto.tink.Key r5) {
            r4 = this;
            boolean r0 = r5 instanceof com.google.crypto.tink.aead.AesGcmKey
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            r0 = r5
            com.google.crypto.tink.aead.AesGcmKey r0 = (com.google.crypto.tink.aead.AesGcmKey) r0
            com.google.crypto.tink.aead.AesGcmParameters r2 = r0.parameters
            com.google.crypto.tink.aead.AesGcmParameters r3 = r4.parameters
    ...
    public /* bridge */ /* synthetic */ com.google.crypto.tink.Parameters getParameters() {
            r1 = this;
            com.google.crypto.tink.aead.AesGcmParameters r0 = r1.getParameters()
            return r0
    }
    ...
    public com.google.crypto.tink.aead.AesGcmParameters getParameters() {
            r1 = this;
            com.google.crypto.tink.aead.AesGcmParameters r0 = r1.parameters
            return r0
    }
}
