...
@kotlin.coroutines.jvm.internal.DebugMetadata(c = "androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1", f = "ScatterMap.kt", i = {0, 0, 0, 0, 0, 0, 0}, l = {1431}, m = "invokeSuspend", n = {"$this$iterator", "m$iv", "lastIndex$iv", "i$iv", "slot$iv", "bitCount$iv", "j$iv"}, s = {"L$0", "L$1", "I$0", "I$1", "J$0", "I$2", "I$3"})
final class MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 extends kotlin.coroutines.jvm.internal.RestrictedSuspendLambda implements kotlin.jvm.functions.Function2<kotlin.sequences.SequenceScope<? super java.lang.Integer>, kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object> {
    ...
    MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(androidx.collection.MutableScatterMap<K, V> r2, kotlin.coroutines.Continuation<? super androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1> r3) {
            r1 = this;
            r1.this$0 = r2
            r0 = 2
            r1.<init>(r0, r3)
    ...
    public final kotlin.coroutines.Continuation<kotlin.Unit> create(java.lang.Object r3, kotlin.coroutines.Continuation<?> r4) {
            r2 = this;
            androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 r0 = new androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1
    ...
    public final java.lang.Object invoke2(kotlin.sequences.SequenceScope<? super java.lang.Integer> r3, kotlin.coroutines.Continuation<? super kotlin.Unit> r4) {
            ...
            androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 r0 = (androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1) r0
