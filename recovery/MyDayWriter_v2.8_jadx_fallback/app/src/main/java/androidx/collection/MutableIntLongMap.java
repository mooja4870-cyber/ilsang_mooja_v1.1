...
public final class MutableIntLongMap extends androidx.collection.IntLongMap {
    ...
    public MutableIntLongMap(int r3) {
            r2 = this;
            r0 = 0
            r2.<init>(r0)
            if (r3 < 0) goto L9
    ...
    public /* synthetic */ MutableIntLongMap(int r1, int r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
            r0 = this;
            r2 = r2 & 1
            if (r2 == 0) goto L5
            r1 = 6
    ...
    public final long getOrPut(int r6, kotlin.jvm.functions.Function0<java.lang.Long> r7) {
            r5 = this;
    ...
    public final void plusAssign(androidx.collection.IntLongMap r2) {
            r1 = this;
    ...
    public final long put(int r5, long r6, long r8) {
            r4 = this;
    ...
    public final void put(int r1, long r2) {
            r0 = this;
            r0.set(r1, r2)
            return
    }

    public final void putAll(androidx.collection.IntLongMap r23) {
            r22 = this;
            java.lang.String r0 = "from"
            r1 = r23
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
    ...
    public final boolean remove(int r5, long r6) {
            r4 = this;
    ...
    public final void removeIf(kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super java.lang.Long, java.lang.Boolean> r21) {
            r20 = this;
            r0 = r20
            r1 = r21
    ...
    public final void set(int r3, long r4) {
            r2 = this;
