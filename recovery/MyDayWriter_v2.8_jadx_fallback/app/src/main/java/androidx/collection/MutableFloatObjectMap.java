...
public final class MutableFloatObjectMap<V> extends androidx.collection.FloatObjectMap<V> {
    ...
    public MutableFloatObjectMap(int r3) {
            r2 = this;
            r0 = 0
            r2.<init>(r0)
            if (r3 < 0) goto L9
    ...
    public /* synthetic */ MutableFloatObjectMap(int r1, int r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
            r0 = this;
            r2 = r2 & 1
            if (r2 == 0) goto L5
            r1 = 6
    ...
    public final V getOrPut(float r5, kotlin.jvm.functions.Function0<? extends V> r6) {
            r4 = this;
    ...
    public final void minusAssign(androidx.collection.FloatList r11) {
            r10 = this;
    ...
    public final void minusAssign(androidx.collection.FloatSet r23) {
            r22 = this;
            java.lang.String r0 = "keys"
            r1 = r23
    ...
    public final void plusAssign(androidx.collection.FloatObjectMap<V> r2) {
            r1 = this;
    ...
    public final V put(float r4, V r5) {
            r3 = this;
    ...
    public final void putAll(androidx.collection.FloatObjectMap<V> r22) {
            r21 = this;
            java.lang.String r0 = "from"
            r1 = r22
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
    ...
    public final void removeIf(kotlin.jvm.functions.Function2<? super java.lang.Float, ? super V, java.lang.Boolean> r19) {
            r18 = this;
            r0 = r18
            r1 = r19
    ...
    public final void set(float r3, V r4) {
            r2 = this;
