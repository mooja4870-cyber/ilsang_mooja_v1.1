...
public final class MutableObjectIntMap<K> extends androidx.collection.ObjectIntMap<K> {
    ...
    public MutableObjectIntMap(int r3) {
            r2 = this;
            r0 = 0
            r2.<init>(r0)
            if (r3 < 0) goto L9
    ...
    public /* synthetic */ MutableObjectIntMap(int r1, int r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
            r0 = this;
            r2 = r2 & 1
            if (r2 == 0) goto L5
            r1 = 6
    ...
    public final int getOrPut(K r4, kotlin.jvm.functions.Function0<java.lang.Integer> r5) {
            r3 = this;
    ...
    public final void plusAssign(androidx.collection.ObjectIntMap<K> r2) {
            r1 = this;
    ...
    public final int put(K r4, int r5, int r6) {
            r3 = this;
    ...
    public final void put(K r1, int r2) {
            r0 = this;
            r0.set(r1, r2)
            return
    }

    public final void putAll(androidx.collection.ObjectIntMap<K> r22) {
            r21 = this;
            java.lang.String r0 = "from"
            r1 = r22
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
    ...
    public final boolean remove(K r3, int r4) {
            r2 = this;
    ...
    public final void removeIf(kotlin.jvm.functions.Function2<? super K, ? super java.lang.Integer, java.lang.Boolean> r19) {
            r18 = this;
            r0 = r18
            r1 = r19
    ...
    public final void set(K r3, int r4) {
            r2 = this;
