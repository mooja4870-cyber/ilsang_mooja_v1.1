...
public final class MutableLongFloatMap extends androidx.collection.LongFloatMap {
    ...
    public MutableLongFloatMap(int r3) {
            r2 = this;
            r0 = 0
            r2.<init>(r0)
            if (r3 < 0) goto L9
    ...
    public /* synthetic */ MutableLongFloatMap(int r1, int r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
            r0 = this;
            r2 = r2 & 1
            if (r2 == 0) goto L5
            r1 = 6
    ...
    public final float getOrPut(long r4, kotlin.jvm.functions.Function0<java.lang.Float> r6) {
            r3 = this;
    ...
    public final void plusAssign(androidx.collection.LongFloatMap r2) {
            r1 = this;
    ...
    public final float put(long r4, float r6, float r7) {
            r3 = this;
    ...
    public final void put(long r1, float r3) {
            r0 = this;
            r0.set(r1, r3)
            return
    }

    public final void putAll(androidx.collection.LongFloatMap r23) {
            r22 = this;
            java.lang.String r0 = "from"
            r1 = r23
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
    ...
    public final boolean remove(long r5, float r7) {
            r4 = this;
    ...
    public final void removeIf(kotlin.jvm.functions.Function2<? super java.lang.Long, ? super java.lang.Float, java.lang.Boolean> r20) {
            r19 = this;
            r0 = r19
            r1 = r20
    ...
    public final void set(long r3, float r5) {
            r2 = this;
