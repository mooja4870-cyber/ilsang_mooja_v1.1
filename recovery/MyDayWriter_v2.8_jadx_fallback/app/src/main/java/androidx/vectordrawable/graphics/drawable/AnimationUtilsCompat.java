...
public class AnimationUtilsCompat {
    ...
    public static android.view.animation.Interpolator loadInterpolator(android.content.Context r1, int r2) throws android.content.res.Resources.NotFoundException {
            android.view.animation.Interpolator r0 = android.view.animation.AnimationUtils.loadInterpolator(r1, r2)
            return r0
    }
}
