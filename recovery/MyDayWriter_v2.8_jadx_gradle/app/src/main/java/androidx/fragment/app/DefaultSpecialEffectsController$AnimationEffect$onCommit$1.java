...
public final class DefaultSpecialEffectsController$AnimationEffect$onCommit$1 implements Animation.AnimationListener {
    ...
    DefaultSpecialEffectsController$AnimationEffect$onCommit$1(SpecialEffectsController.Operation $operation, ViewGroup $container, View $viewToAnimate, DefaultSpecialEffectsController.AnimationEffect $receiver) {
    ...
    public void onAnimationEnd(Animation animation) {
        ...
        viewGroup.post(new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController$AnimationEffect$onCommit$1$$ExternalSyntheticLambda0
            ...
            public final void run() {
                DefaultSpecialEffectsController$AnimationEffect$onCommit$1.onAnimationEnd$lambda$0(viewGroup2, view, animationEffect);
            }
        });
        if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public static final void onAnimationEnd$lambda$0(ViewGroup container, View $viewToAnimate, DefaultSpecialEffectsController.AnimationEffect this$0) {
