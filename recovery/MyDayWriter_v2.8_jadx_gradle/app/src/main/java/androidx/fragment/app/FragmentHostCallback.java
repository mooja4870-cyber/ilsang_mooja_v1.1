...
public abstract class FragmentHostCallback<H> extends FragmentContainer {
    ...
    public FragmentHostCallback(Activity activity, Context context, Handler handler, int windowAnimations) {
    ...
    /* JADX INFO: renamed from: onGetWindowAnimations, reason: from getter */
