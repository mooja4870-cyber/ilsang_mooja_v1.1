...
class FragmentTransitionCompat21 extends FragmentTransitionImpl {
    ...
    public boolean isSeekingSupported(Object transition) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Predictive back not available for framework transition " + transition + ". Please switch to AndroidX Transition 1.5.0 or higher to enable seeking.");
            return false;
        }
        return false;
    }
