...
public abstract class FragmentTransaction {
    ...
    public final FragmentTransaction add(ViewGroup container, Fragment fragment, String tag) {
    ...
    FragmentTransaction runOnCommitInternal(boolean allowAddToBackStack, Runnable runnable) {
