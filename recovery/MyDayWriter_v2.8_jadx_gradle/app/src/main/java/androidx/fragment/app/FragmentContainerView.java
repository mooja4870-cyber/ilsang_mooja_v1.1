...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            TypedArray $this$_init__u24lambda_u240 = context.obtainStyledAttributes(attrs, FragmentContainerView, 0, 0);
            if (classAttribute == null) {
                classAttribute = $this$_init__u24lambda_u240.getString(R.styleable.FragmentContainerView_android_name);
                str = "android:name";
            }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, FragmentManager fm) {
        ...
        int[] FragmentContainerView = R.styleable.FragmentContainerView;
        Intrinsics.checkNotNullExpressionValue(FragmentContainerView, "FragmentContainerView");
        TypedArray $this$_init__u24lambda_u241 = context.obtainStyledAttributes(attrs, FragmentContainerView, 0, 0);
        classAttribute = classAttribute == null ? $this$_init__u24lambda_u241.getString(R.styleable.FragmentContainerView_android_name) : classAttribute;
        String string = $this$_init__u24lambda_u241.getString(R.styleable.FragmentContainerView_android_tag);
        ...
        if (classAttribute != null && existingFragment == null) {
            ...
            containerFragment.mTag = string;
            containerFragment.mFragmentManager = fm;
            containerFragment.mHost = fm.getHost();
