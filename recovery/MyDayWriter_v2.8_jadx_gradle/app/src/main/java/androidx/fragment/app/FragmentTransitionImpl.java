...
public abstract class FragmentTransitionImpl {
    ...
    public void setListenerForTransitionEnd(Fragment outFragment, Object transition, CancellationSignal signal, Runnable cancelRunnable, Runnable transitionCompleteRunnable) {
