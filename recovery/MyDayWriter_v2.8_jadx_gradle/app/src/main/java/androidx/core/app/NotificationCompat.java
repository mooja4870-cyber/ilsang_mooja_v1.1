...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m45clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m46clone() {
            WearableExtender that = new WearableExtender();
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle b) {
            ...
            if (remoteInput != null) {
                ...
                remoteInputCompat = new RemoteInput(resultKey, label, choices, allowFreeFormInput, editChoicesBeforeSending, Api20Impl.getExtras(remoteInput), null);
            } else {
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        IconCompat iconCompatCreateFromIconOrNullIfZeroResId;
        ...
        if (srcArray == null) {
            ...
            for (int i = 0; i < srcArray.length; i++) {
                ...
                remoteInputs2[i] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, editChoicesBeforeSending, Api20Impl.getExtras(src), null);
            }
        ...
        if (Api23Impl.getIcon(action) != null) {
            iconCompatCreateFromIconOrNullIfZeroResId = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action));
        } else {
            iconCompatCreateFromIconOrNullIfZeroResId = null;
        }
        IconCompat icon = iconCompatCreateFromIconOrNullIfZeroResId;
