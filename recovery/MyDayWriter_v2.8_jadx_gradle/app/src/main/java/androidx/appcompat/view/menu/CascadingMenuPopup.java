    ...
    private void showMenu(MenuBuilder menu) {
        ...
        if (parentView != null) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                ...
                parentOffsetX = parentViewScreenLocation[c] - anchorScreenLocation[c];
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            boolean z = c;
            FrameLayout frameLayout = (FrameLayout) layoutInflaterFrom.inflate(R.layout.abc_popup_menu_header_item_layout, listView, z);
            TextView titleView = (TextView) frameLayout.findViewById(android.R.id.title);
            frameLayout.setEnabled(z);
            titleView.setText(menu.getHeaderTitle());
            listView.addHeaderView(frameLayout, null, z);
            popupWindow.show();
        }
    }
