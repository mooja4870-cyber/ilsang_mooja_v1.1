...
public abstract class ObjectFloatMap<K> {
    ...
    */
    ...
    public boolean equals(Object other) {
        ...
        boolean z2 = false;
        if (!(other instanceof ObjectFloatMap) || ((ObjectFloatMap) other).get_size() != get_size()) {
            return false;
        }
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z3 : z4)) {
                        ...
                        Object key = k$iv[index$iv$iv];
                        float value = v$iv[index$iv$iv];
                        if (!(value == objectFloatMap.get(key) ? z3 : z4)) {
                            return z4;
                        }
                    }
                    slot$iv$iv >>= i;
