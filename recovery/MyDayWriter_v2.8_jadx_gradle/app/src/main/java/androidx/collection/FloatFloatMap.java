...
public abstract class FloatFloatMap {
    ...
    */
    ...
    public boolean equals(Object other) {
        ...
        boolean z4 = false;
        if (!(other instanceof FloatFloatMap) || ((FloatFloatMap) other).get_size() != get_size()) {
            return false;
        }
        int $i$f$forEach = 0;
        float[] k$iv = this.keys;
            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv == -9187201950435737472L) {
                ...
                while (j$iv$iv < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z5 : z6)) {
                        ...
                        float value = v$iv[index$iv$iv];
                        i = i2;
                        if (!(value == ((FloatFloatMap) other).get(key) ? z5 : z2)) {
                            return z2;
                        }
                    }
                    slot$iv$iv >>= i;
