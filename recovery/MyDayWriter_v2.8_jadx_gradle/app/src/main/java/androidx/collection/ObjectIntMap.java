            ...
            if ($this$maskEmptyOrDeleted$iv$iv$iv != -9187201950435737472L) {
                ...
                while (j$iv$iv2 < bitCount$iv$iv) {
                    ...
                    if (!(value$iv$iv$iv < 128 ? z3 : z4)) {
                        ...
                        int value = v$iv[index$iv$iv];
                        j$iv$iv = j$iv$iv2;
                        int j$iv$iv3 = objectIntMap.get(key);
                        if (value != j$iv$iv3) {
                            return z4;
                        }
                    }
