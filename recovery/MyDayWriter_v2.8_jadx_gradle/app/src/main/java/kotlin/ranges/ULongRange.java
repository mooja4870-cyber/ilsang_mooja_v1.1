...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong>, OpenEndRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable value) {
        return m1390containsVKZWuLQ(((ULong) value).getData());
    }

    @Override // kotlin.ranges.OpenEndRange
    public /* bridge */ /* synthetic */ Comparable getEndExclusive() {
        return ULong.m321boximpl(m1391getEndExclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return ULong.m321boximpl(m1392getEndInclusivesVKNKU());
    }

    @Override // kotlin.ranges.ClosedRange
    public /* bridge */ /* synthetic */ Comparable getStart() {
        return ULong.m321boximpl(m1393getStartsVKNKU());
    }
    ...
    public long m1391getEndExclusivesVKNKU() {
        ...
        return ULong.m327constructorimpl(getLast() + ULong.m327constructorimpl(((long) 1) & 4294967295L));
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m1390containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return (((int) ULong.m327constructorimpl(getFirst() ^ ULong.m327constructorimpl(getFirst() >>> 32))) * 31) + ((int) ULong.m327constructorimpl(getLast() ^ ULong.m327constructorimpl(getLast() >>> 32)));
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ((Object) ULong.m373toStringimpl(getFirst())) + ".." + ((Object) ULong.m373toStringimpl(getLast()));
    }
