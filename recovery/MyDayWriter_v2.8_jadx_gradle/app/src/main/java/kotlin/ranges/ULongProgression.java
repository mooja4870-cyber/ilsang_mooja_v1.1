...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long start, long endInclusive, long step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1361getProgressionLastElement7ftBX0g(start, endInclusive, step);
        this.step = step;
    }
    ...
    public int hashCode() {
        ...
        return (((((int) ULong.m327constructorimpl(this.first ^ ULong.m327constructorimpl(this.first >>> 32))) * 31) + ((int) ULong.m327constructorimpl(this.last ^ ULong.m327constructorimpl(this.last >>> 32)))) * 31) + ((int) (this.step ^ (this.step >>> 32)));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m373toStringimpl(this.first)).append("..").append((Object) ULong.m373toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m373toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m373toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
