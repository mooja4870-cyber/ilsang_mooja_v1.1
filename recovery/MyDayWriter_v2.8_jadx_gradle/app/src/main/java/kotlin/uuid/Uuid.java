...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> action) {
        Intrinsics.checkNotNullParameter(action, "action");
        return action.invoke(ULong.m321boximpl(ULong.m327constructorimpl(getMostSignificantBits())), ULong.m321boximpl(ULong.m327constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m1642fromULongseb3DHEI(long mostSignificantBits, long leastSignificantBits) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid a, Uuid b) {
        return a.mostSignificantBits != b.mostSignificantBits ? Long.compare(ULong.m327constructorimpl(a.mostSignificantBits) ^ Long.MIN_VALUE, ULong.m327constructorimpl(b.mostSignificantBits) ^ Long.MIN_VALUE) : Long.compare(ULong.m327constructorimpl(a.leastSignificantBits) ^ Long.MIN_VALUE, ULong.m327constructorimpl(b.leastSignificantBits) ^ Long.MIN_VALUE);
    }
}
