...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo1470minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1616minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo1469elapsedNowUwyO8pc() {
        return Duration.m1514minusLRDsOJo(this.mark.mo1469elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo1472plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1515plusLRDsOJo(this.adjustment, duration), null);
    }
}
