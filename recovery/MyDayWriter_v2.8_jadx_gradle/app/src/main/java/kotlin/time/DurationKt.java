...
public final class DurationKt {
    ...
    private static final long m1606timesmvk6XK0(int $this$times_u2dmvk6XK0, long duration) {
        return Duration.m1517timesUwyO8pc(duration, $this$times_u2dmvk6XK0);
    }
    ...
    private static final long m1605timeskIfJnKk(double $this$times_u2dkIfJnKk, long duration) {
        return Duration.m1516timesUwyO8pc(duration, $this$times_u2dkIfJnKk);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Removed duplicated region for block: B:199:0x00d0 A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:51:0x00b5 A[LOOP:1: B:35:0x0073->B:51:0x00b5, LOOP_END] */
    /*
    ...
    */
            ...
            if (!($this$all$iv instanceof Collection) || !((Collection) $this$all$iv).isEmpty()) {
                ...
                while (true) {
                    if (it.hasNext()) {
                        ...
                        char cCharAt = value.charAt(element$iv);
                        int it2 = ('0' > cCharAt || cCharAt >= ':') ? 0 : 1;
                        if (it2 == 0) {
                            z = false;
                            break;
                        }
    ...
    public static final long durationOfNanos(long normalNanos) {
        return Duration.m1479constructorimpl(normalNanos << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long normalMillis) {
        return Duration.m1479constructorimpl((normalMillis << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long normalValue, int unitDiscriminator) {
        return Duration.m1479constructorimpl((normalValue << 1) + ((long) unitDiscriminator));
    }
