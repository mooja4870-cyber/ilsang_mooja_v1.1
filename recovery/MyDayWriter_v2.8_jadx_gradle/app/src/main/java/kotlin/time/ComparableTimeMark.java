...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1470minusLRDsOJo(long duration);

    /* JADX INFO: renamed from: minus-UwyO8pc */
    long mo1471minusUwyO8pc(ComparableTimeMark other);

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1472plusLRDsOJo(long duration);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1474minusLRDsOJo(ComparableTimeMark $this, long duration) {
        ...
        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            ...
            return Duration.m1478compareToLRDsOJo($this.mo1471minusUwyO8pc(other), Duration.INSTANCE.m1582getZEROUwyO8pc());
        }
    }
}
