...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public long mo1469elapsedNowUwyO8pc() {
            return Duration.m1514minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        @Override // kotlin.time.TimeMark
        /* JADX INFO: renamed from: plus-LRDsOJo, reason: not valid java name */
        public ComparableTimeMark mo1472plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1515plusLRDsOJo(this.offset, duration), null);
        }
        ...
        public long mo1471minusUwyO8pc(ComparableTimeMark other) {
            ...
            if (Duration.m1484equalsimpl0(this.offset, ((DoubleTimeMark) other).offset) && Duration.m1511isInfiniteimpl(this.offset)) {
                return Duration.INSTANCE.m1582getZEROUwyO8pc();
            }
            long offsetDiff = Duration.m1514minusLRDsOJo(this.offset, ((DoubleTimeMark) other).offset);
            long startedAtDiff = DurationKt.toDuration(this.startedAt - ((DoubleTimeMark) other).startedAt, this.timeSource.getUnit());
            return Duration.m1484equalsimpl0(startedAtDiff, Duration.m1532unaryMinusUwyO8pc(offsetDiff)) ? Duration.INSTANCE.m1582getZEROUwyO8pc() : Duration.m1515plusLRDsOJo(startedAtDiff, offsetDiff);
        }

        @Override // kotlin.time.ComparableTimeMark
        public boolean equals(Object other) {
            return (other instanceof DoubleTimeMark) && Intrinsics.areEqual(this.timeSource, ((DoubleTimeMark) other).timeSource) && Duration.m1484equalsimpl0(mo1471minusUwyO8pc((ComparableTimeMark) other), Duration.INSTANCE.m1582getZEROUwyO8pc());
        }

        @Override // kotlin.time.ComparableTimeMark
        public int hashCode() {
            return Duration.m1507hashCodeimpl(Duration.m1515plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + ((Object) Duration.m1528toStringimpl(this.offset)) + ", " + this.timeSource + ')';
        }
    }

    @Override // kotlin.time.TimeSource
    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.INSTANCE.m1582getZEROUwyO8pc(), null);
    }
}
