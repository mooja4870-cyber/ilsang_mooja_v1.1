...
public final class UnsignedKt {
    ...
    public static final int m505uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m248constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: uintDivide-J1ME1BU, reason: not valid java name */
    public static final int m504uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m248constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m506ulongDivideeb3DHEI(long v1, long v2) {
        if (v2 < 0) {
            return ULong.m327constructorimpl(Long.compare(v1 ^ Long.MIN_VALUE, v2 ^ Long.MIN_VALUE) >= 0 ? 1L : 0L);
        }
        if (v1 >= 0) {
            return ULong.m327constructorimpl(v1 / v2);
        }
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        return ULong.m327constructorimpl(((long) (Long.compare(ULong.m327constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m327constructorimpl(v2) ^ Long.MIN_VALUE) < 0 ? 0 : 1)) + quotient);
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m507ulongRemaindereb3DHEI(long v1, long v2) {
        long j = 0;
        if (v2 < 0) {
        ...
        long quotient = ((v1 >>> 1) / v2) << 1;
        long rem = v1 - (quotient * v2);
        if (Long.compare(ULong.m327constructorimpl(rem) ^ Long.MIN_VALUE, ULong.m327constructorimpl(v2) ^ Long.MIN_VALUE) >= 0) {
            j = v2;
        }
        return ULong.m327constructorimpl(rem - j);
    }
    ...
    private static final long uintToULong(int value) {
        return ULong.m327constructorimpl(((long) value) & 4294967295L);
    }
    ...
    public static final int doubleToUInt(double value) {
        ...
        return value <= 2.147483647E9d ? UInt.m248constructorimpl((int) value) : UInt.m248constructorimpl(UInt.m248constructorimpl((int) (value - ((double) Integer.MAX_VALUE))) + UInt.m248constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double value) {
        ...
        return value < 9.223372036854776E18d ? ULong.m327constructorimpl((long) value) : ULong.m327constructorimpl(ULong.m327constructorimpl((long) (value - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
