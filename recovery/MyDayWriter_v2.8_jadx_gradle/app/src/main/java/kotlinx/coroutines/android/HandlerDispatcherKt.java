...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            objM153constructorimpl = Result.m153constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM153constructorimpl = Result.m153constructorimpl(ResultKt.createFailure(th));
        }
        Main = (HandlerDispatcher) (Result.m159isFailureimpl(objM153constructorimpl) ? null : objM153constructorimpl);
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo1712dispatch(cont.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
