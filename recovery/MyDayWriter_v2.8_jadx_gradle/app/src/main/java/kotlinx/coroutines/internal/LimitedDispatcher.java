...
public final class LimitedDispatcher extends CoroutineDispatcher implements Delay {
    ...
    public void mo1713scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1713scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    public void mo1712dispatch(CoroutineContext context, Runnable block) {
        ...
        if (runningWorkers$volatile$FU.get(this) < this.parallelism && tryAllocateWorker() && (task$iv = obtainTaskOrDeallocateWorker()) != null) {
            ...
            this.dispatcher.mo1712dispatch(this, worker);
        }
    }
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (fairnessCounter >= 16 && LimitedDispatcher.this.dispatcher.isDispatchNeeded(LimitedDispatcher.this)) {
                    LimitedDispatcher.this.dispatcher.mo1712dispatch(LimitedDispatcher.this, this);
                    return;
                }
            }
        }
