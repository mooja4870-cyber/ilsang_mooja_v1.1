...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    s.mo1656trySendJP2dKIU(getValue());
                }
    ...
    */
    ...
    public Object mo1656trySendJP2dKIU(E element) {
        ...
        try {
            if (isClosedForSend()) {
                return super.mo1656trySendJP2dKIU(element);
            }
            ...
            if (shouldSuspend) {
                return ChannelResult.INSTANCE.m1681failurePtdJZtk();
            }
            if (this.capacity == -1) {
            ...
            for (Object element$iv2 : $this$forEach$iv) {
                ...
                it3.mo1656trySendJP2dKIU(element);
            }
