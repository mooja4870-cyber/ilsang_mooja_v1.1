...
public interface SendChannel<E> {
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object result = sendChannel.mo1656trySendJP2dKIU(e);
            if (ChannelResult.m1677isSuccessimpl(result)) {
                return true;
            }
            Throwable thM1671exceptionOrNullimpl = ChannelResult.m1671exceptionOrNullimpl(result);
