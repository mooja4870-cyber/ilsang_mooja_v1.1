...
public interface ReceiveChannel<E> {
    ...
    Object mo1660receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo1661tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo1661tryReceivePtdJZtk = receiveChannel.mo1661tryReceivePtdJZtk();
            if (ChannelResult.m1677isSuccessimpl(objMo1661tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1673getOrThrowimpl(objMo1661tryReceivePtdJZtk);
            }
            Throwable thM1671exceptionOrNullimpl = ChannelResult.m1671exceptionOrNullimpl(objMo1661tryReceivePtdJZtk);
            if (thM1671exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM1671exceptionOrNullimpl);
        }
