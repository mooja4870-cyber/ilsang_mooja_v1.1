...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m1651SupervisorJob(Job parent) {
        return SupervisorJob(parent);
    }

    /* JADX INFO: renamed from: SupervisorJob$default, reason: collision with other method in class */
    public static /* synthetic */ Job m1652SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m1651SupervisorJob(job);
    }
