...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM153constructorimpl = Result.m153constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM153constructorimpl = Result.m153constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m159isFailureimpl(objM153constructorimpl) ? null : objM153constructorimpl);
