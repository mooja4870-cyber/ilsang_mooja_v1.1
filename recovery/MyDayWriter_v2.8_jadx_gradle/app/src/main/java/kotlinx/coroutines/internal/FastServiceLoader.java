...
public final class FastServiceLoader {
    ...
    public final List<MainDispatcherFactory> loadMainDispatcherFactory$kotlinx_coroutines_core() {
        MainDispatcherFactory $this$loadMainDispatcherFactory_u24lambda_u240;
        if (!FastServiceLoaderKt.getANDROID_DETECTED()) {
            return load(MainDispatcherFactory.class, MainDispatcherFactory.class.getClassLoader());
        }
        try {
            ArrayList result = new ArrayList(2);
            MainDispatcherFactory $this$loadMainDispatcherFactory_u24lambda_u241 = null;
            try {
                $this$loadMainDispatcherFactory_u24lambda_u240 = (MainDispatcherFactory) MainDispatcherFactory.class.cast(Class.forName("kotlinx.coroutines.android.AndroidDispatcherFactory", true, MainDispatcherFactory.class.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            } catch (ClassNotFoundException e) {
                $this$loadMainDispatcherFactory_u24lambda_u240 = null;
            }
            if ($this$loadMainDispatcherFactory_u24lambda_u240 != null) {
                result.add($this$loadMainDispatcherFactory_u24lambda_u240);
            }
            try {
                $this$loadMainDispatcherFactory_u24lambda_u241 = (MainDispatcherFactory) MainDispatcherFactory.class.cast(Class.forName("kotlinx.coroutines.test.internal.TestMainDispatcherFactory", true, MainDispatcherFactory.class.getClassLoader()).getDeclaredConstructor(new Class[0]).newInstance(new Object[0]));
            } catch (ClassNotFoundException e2) {
            }
            if ($this$loadMainDispatcherFactory_u24lambda_u241 != null) {
