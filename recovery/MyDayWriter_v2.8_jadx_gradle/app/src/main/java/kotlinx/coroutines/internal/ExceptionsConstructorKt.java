...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM153constructorimpl = Result.m153constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM153constructorimpl;
        }
    ...
    public static final <E extends Throwable> Function1<Throwable, Throwable> createConstructor(Class<E> cls) {
        ...
        while (true) {
            ...
            switch (parameterTypes.length) {
                ...
                case 2:
                    i = i2;
                    pair = (!Intrinsics.areEqual(parameterTypes[i2], String.class) || !Intrinsics.areEqual(parameterTypes[1], Throwable.class)) ? TuplesKt.to(null, -1) : TuplesKt.to(safeCtor(new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$createConstructor$1$1
                        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                        {
                            super(1);
                        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    objM153constructorimpl = Result.m153constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM153constructorimpl = Result.m153constructorimpl(ResultKt.createFailure(th));
                }
                return (Throwable) (Result.m159isFailureimpl(objM153constructorimpl) ? null : objM153constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM153constructorimpl = Result.m153constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM153constructorimpl = Result.m153constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m159isFailureimpl(objM153constructorimpl)) {
            objM153constructorimpl = numValueOf;
        }
        return ((Number) objM153constructorimpl).intValue();
    }
