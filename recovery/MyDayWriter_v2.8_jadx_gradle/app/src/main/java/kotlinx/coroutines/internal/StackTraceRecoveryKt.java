...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM153constructorimpl2;
        ...
        try {
            ...
            objM153constructorimpl = Result.m153constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM153constructorimpl = Result.m153constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m156exceptionOrNullimpl(objM153constructorimpl) == null) {
            obj2 = objM153constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM153constructorimpl2 = Result.m153constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM153constructorimpl2 = Result.m153constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m156exceptionOrNullimpl(objM153constructorimpl2) == null) {
            obj = objM153constructorimpl2;
        }
