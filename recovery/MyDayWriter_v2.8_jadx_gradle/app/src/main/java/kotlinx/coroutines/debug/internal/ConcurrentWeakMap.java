        ...
        public final Object putImpl(K key, V value, HashedWeakRef<K> weakKey0) {
            ...
            while (true) {
                ...
                if (w != null) {
                    ...
                    if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getKeys(), index, null, hashedWeakRef)) {
                        break;
                    }
                }
            }
            ...
            } while (!ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getValues(), index, oldValue, value));
            return oldValue;
        }
                ...
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    while (true) {
                        ...
                        if (!(obj instanceof Marked)) {
                            if (ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m(getValues(), i2, obj, ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
