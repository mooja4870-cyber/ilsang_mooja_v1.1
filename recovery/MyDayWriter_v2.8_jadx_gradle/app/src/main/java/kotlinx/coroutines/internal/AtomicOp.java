...
public abstract class AtomicOp<T> extends OpDescriptor {
    ...
    private final Object decide(Object decision) {
        ...
        Object current = _consensus$volatile$FU.get(this);
        return current != AtomicKt.NO_DECISION ? current : AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_consensus$volatile$FU, this, AtomicKt.NO_DECISION, decision) ? decision : _consensus$volatile$FU.get(this);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // kotlinx.coroutines.internal.OpDescriptor
    public final Object perform(Object affected) {
        Object decision = _consensus$volatile$FU.get(this);
        if (decision == AtomicKt.NO_DECISION) {
