...
public enum HpkeKdf extends java.lang.Enum<com.google.crypto.tink.proto.HpkeKdf> implements com.google.crypto.tink.shaded.protobuf.Internal.EnumLite {
    ...
    private static final class HpkeKdfVerifier implements com.google.crypto.tink.shaded.protobuf.Internal.EnumVerifier {
        ...
        public boolean isInRange(int r2) {
                r1 = this;
                com.google.crypto.tink.proto.HpkeKdf r0 = com.google.crypto.tink.proto.HpkeKdf.forNumber(r2)
                if (r0 == 0) goto L8
                r0 = 1
                goto L9
            L8:
    ...
    static {
            ...
            com.google.crypto.tink.proto.HpkeKdf r0 = new com.google.crypto.tink.proto.HpkeKdf
            java.lang.String r1 = "HKDF_SHA256"
            r2 = 1
            r0.<init>(r1, r2, r2)
            com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA256 = r0
            com.google.crypto.tink.proto.HpkeKdf r0 = new com.google.crypto.tink.proto.HpkeKdf
            java.lang.String r1 = "HKDF_SHA384"
            r2 = 2
            r0.<init>(r1, r2, r2)
            com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA384 = r0
            com.google.crypto.tink.proto.HpkeKdf r0 = new com.google.crypto.tink.proto.HpkeKdf
            java.lang.String r1 = "HKDF_SHA512"
            r2 = 3
            r0.<init>(r1, r2, r2)
            com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA512 = r0
            com.google.crypto.tink.proto.HpkeKdf r0 = new com.google.crypto.tink.proto.HpkeKdf
            r1 = 4
            r2 = -1
            java.lang.String r3 = "UNRECOGNIZED"
            r0.<init>(r3, r1, r2)
            com.google.crypto.tink.proto.HpkeKdf.UNRECOGNIZED = r0
            com.google.crypto.tink.proto.HpkeKdf r0 = com.google.crypto.tink.proto.HpkeKdf.KDF_UNKNOWN
            com.google.crypto.tink.proto.HpkeKdf r1 = com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA256
            com.google.crypto.tink.proto.HpkeKdf r2 = com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA384
            com.google.crypto.tink.proto.HpkeKdf r3 = com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA512
            com.google.crypto.tink.proto.HpkeKdf r4 = com.google.crypto.tink.proto.HpkeKdf.UNRECOGNIZED
    ...
    public static com.google.crypto.tink.proto.HpkeKdf forNumber(int r1) {
        ...
        L5:
            ...
            return r0
        L8:
            com.google.crypto.tink.proto.HpkeKdf r0 = com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA384
            return r0
        Lb:
            com.google.crypto.tink.proto.HpkeKdf r0 = com.google.crypto.tink.proto.HpkeKdf.HKDF_SHA256
            return r0
        Le:
            com.google.crypto.tink.proto.HpkeKdf r0 = com.google.crypto.tink.proto.HpkeKdf.KDF_UNKNOWN
            return r0
    ...
    public static com.google.crypto.tink.proto.HpkeKdf valueOf(int r1) {
            com.google.crypto.tink.proto.HpkeKdf r0 = forNumber(r1)
            return r0
    }
