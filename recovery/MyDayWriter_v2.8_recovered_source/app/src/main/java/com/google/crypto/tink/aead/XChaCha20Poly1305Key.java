...
public final class XChaCha20Poly1305Key extends com.google.crypto.tink.aead.AeadKey {
    ...
    public static com.google.crypto.tink.aead.XChaCha20Poly1305Key create(com.google.crypto.tink.aead.XChaCha20Poly1305Parameters.Variant r3, com.google.crypto.tink.util.SecretBytes r4, @javax.annotation.Nullable java.lang.Integer r5) throws java.security.GeneralSecurityException {
        ...
        L35:
            ...
            r1 = 32
            if (r0 != r1) goto L4b
            com.google.crypto.tink.aead.XChaCha20Poly1305Parameters r0 = com.google.crypto.tink.aead.XChaCha20Poly1305Parameters.create(r3)
            com.google.crypto.tink.aead.XChaCha20Poly1305Key r1 = new com.google.crypto.tink.aead.XChaCha20Poly1305Key
        ...
        L4b:
            ...
            java.lang.StringBuilder r1 = new java.lang.StringBuilder
            r1.<init>()
            java.lang.String r2 = "XChaCha20Poly1305 key must be constructed with key of length 32 bytes, not "
            java.lang.StringBuilder r1 = r1.append(r2)
            int r2 = r4.size()
            java.lang.StringBuilder r1 = r1.append(r2)
            java.lang.String r1 = r1.toString()
    ...
    public static com.google.crypto.tink.aead.XChaCha20Poly1305Key create(com.google.crypto.tink.util.SecretBytes r2) throws java.security.GeneralSecurityException {
            com.google.crypto.tink.aead.XChaCha20Poly1305Parameters$Variant r0 = com.google.crypto.tink.aead.XChaCha20Poly1305Parameters.Variant.NO_PREFIX
            r1 = 0
            com.google.crypto.tink.aead.XChaCha20Poly1305Key r0 = create(r0, r2, r1)
            return r0
    }
    ...
    private static com.google.crypto.tink.util.Bytes getOutputPrefix(com.google.crypto.tink.aead.XChaCha20Poly1305Parameters r4, @javax.annotation.Nullable java.lang.Integer r5) {
        ...
        L54:
            ...
            java.lang.StringBuilder r1 = r1.append(r2)
            com.google.crypto.tink.aead.XChaCha20Poly1305Parameters$Variant r2 = r4.getVariant()
            java.lang.StringBuilder r1 = r1.append(r2)
            java.lang.String r1 = r1.toString()
            r0.<init>(r1)
            throw r0
    ...
    public boolean equalsKey(com.google.crypto.tink.Key r5) {
            r4 = this;
            boolean r0 = r5 instanceof com.google.crypto.tink.aead.XChaCha20Poly1305Key
            r1 = 0
            if (r0 != 0) goto L6
            return r1
        L6:
            r0 = r5
            com.google.crypto.tink.aead.XChaCha20Poly1305Key r0 = (com.google.crypto.tink.aead.XChaCha20Poly1305Key) r0
            com.google.crypto.tink.aead.XChaCha20Poly1305Parameters r2 = r0.parameters
            com.google.crypto.tink.aead.XChaCha20Poly1305Parameters r3 = r4.parameters
