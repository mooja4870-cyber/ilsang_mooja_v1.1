...
class EdgeToEdgeApi29 extends androidx.activity.EdgeToEdgeApi28 {
    ...
    public void setUp(androidx.activity.SystemBarStyle r4, androidx.activity.SystemBarStyle r5, android.view.Window r6, android.view.View r7, boolean r8, boolean r9) {
            ...
            int r1 = r4.getScrimWithEnforcedContrast$activity_release(r8)
            r6.setStatusBarColor(r1)
            int r1 = r5.getScrimWithEnforcedContrast$activity_release(r9)
            r6.setNavigationBarColor(r1)
            r6.setStatusBarContrastEnforced(r0)
            int r1 = r5.getNightMode$activity_release()
            if (r1 != 0) goto L32
            r0 = 1
        L32:
            r6.setNavigationBarContrastEnforced(r0)
