...
public final class MutableIntFloatMap extends androidx.collection.IntFloatMap {
    ...
    public MutableIntFloatMap(int r3) {
            r2 = this;
            r0 = 0
            r2.<init>(r0)
            if (r3 < 0) goto L9
    ...
    public /* synthetic */ MutableIntFloatMap(int r1, int r2, kotlin.jvm.internal.DefaultConstructorMarker r3) {
            r0 = this;
            r2 = r2 & 1
            if (r2 == 0) goto L5
            r1 = 6
    ...
    private final void resizeStorage(int r27) {
        ...
        L2c:
            ...
            r8 = r2[r7]
            r9 = 0
            int r10 = java.lang.Integer.hashCode(r8)
    ...
    public final float getOrPut(int r4, kotlin.jvm.functions.Function0<java.lang.Float> r5) {
            r3 = this;
    ...
    public final void minusAssign(androidx.collection.IntList r9) {
            r8 = this;
    ...
    public final void minusAssign(androidx.collection.IntSet r21) {
            r20 = this;
            java.lang.String r0 = "keys"
            r1 = r21
    ...
    public final void minusAssign(int[] r5) {
            r4 = this;
            java.lang.String r0 = "keys"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r5, r0)
            r0 = 0
    ...
    public final void plusAssign(androidx.collection.IntFloatMap r2) {
            r1 = this;
    ...
    public final float put(int r4, float r5, float r6) {
            r3 = this;
    ...
    public final void put(int r1, float r2) {
            r0 = this;
            r0.set(r1, r2)
            return
    }

    public final void putAll(androidx.collection.IntFloatMap r22) {
            r21 = this;
            java.lang.String r0 = "from"
            r1 = r22
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r1, r0)
    ...
    public final boolean remove(int r5, float r6) {
            r4 = this;
    ...
    public final void removeIf(kotlin.jvm.functions.Function2<? super java.lang.Integer, ? super java.lang.Float, java.lang.Boolean> r19) {
            r18 = this;
            r0 = r18
            r1 = r19
    ...
    public final void set(int r3, float r4) {
            r2 = this;
