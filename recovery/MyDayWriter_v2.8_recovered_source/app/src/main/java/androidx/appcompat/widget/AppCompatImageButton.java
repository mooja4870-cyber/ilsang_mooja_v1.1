...
public class AppCompatImageButton extends android.widget.ImageButton implements androidx.core.view.TintableBackgroundView, androidx.core.widget.TintableImageSourceView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<androidx.appcompat.widget.AppCompatImageButton> {
        ...
        public void readProperties2(androidx.appcompat.widget.AppCompatImageButton r3, android.view.inspector.PropertyReader r4) {
                r2 = this;
        ...
        @Override // android.view.inspector.InspectionCompanion
        public /* bridge */ /* synthetic */ void readProperties(androidx.appcompat.widget.AppCompatImageButton r1, android.view.inspector.PropertyReader r2) {
                r0 = this;
    ...
    public AppCompatImageButton(android.content.Context r2, android.util.AttributeSet r3, int r4) {
            r1 = this;
