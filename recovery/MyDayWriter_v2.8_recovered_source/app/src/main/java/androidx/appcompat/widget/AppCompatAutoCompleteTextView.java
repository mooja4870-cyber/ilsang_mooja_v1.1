...
public class AppCompatAutoCompleteTextView extends android.widget.AutoCompleteTextView implements androidx.core.view.TintableBackgroundView, androidx.appcompat.widget.EmojiCompatConfigurationView, androidx.core.widget.TintableCompoundDrawablesView {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion<androidx.appcompat.widget.AppCompatAutoCompleteTextView> {
        ...
        public void readProperties2(androidx.appcompat.widget.AppCompatAutoCompleteTextView r3, android.view.inspector.PropertyReader r4) {
                r2 = this;
        ...
        @Override // android.view.inspector.InspectionCompanion
        public /* bridge */ /* synthetic */ void readProperties(androidx.appcompat.widget.AppCompatAutoCompleteTextView r1, android.view.inspector.PropertyReader r2) {
                r0 = this;
    ...
    public AppCompatAutoCompleteTextView(android.content.Context r4, android.util.AttributeSet r5, int r6) {
            ...
            android.content.Context r0 = r3.getContext()
            int[] r1 = androidx.appcompat.widget.AppCompatAutoCompleteTextView.TINT_ATTRS
            r2 = 0
