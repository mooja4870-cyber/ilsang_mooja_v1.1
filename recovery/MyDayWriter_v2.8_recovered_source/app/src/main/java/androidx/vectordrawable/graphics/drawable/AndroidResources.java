...
class AndroidResources {
    ...
    static {
            r0 = 9
            int[] r0 = new int[r0]
            r0 = {x008c: FILL_ARRAY_DATA , data: [16842755, 16843041, 16843093, 16843097, 16843551, 16843754, 16843771, 16843778, 16843779} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = r0
            r0 = 8
            int[] r1 = new int[r0]
            r1 = {x00a2: FILL_ARRAY_DATA , data: [16842755, 16843189, 16843190, 16843556, 16843557, 16843558, 16843866, 16843867} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_GROUP = r1
            r1 = 14
            int[] r1 = new int[r1]
            r1 = {x00b6: FILL_ARRAY_DATA , data: [16842755, 16843780, 16843781, 16843782, 16843783, 16843784, 16843785, 16843786, 16843787, 16843788, 16843789, 16843979, 16843980, 16844062} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_PATH = r1
            r1 = 16842755(0x1010003, float:2.3693566E-38)
            r2 = 16843781(0x1010405, float:2.3696442E-38)
            r3 = 16844062(0x101051e, float:2.369723E-38)
            int[] r3 = new int[]{r1, r2, r3}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = r3
            r3 = 16843161(0x1010199, float:2.3694704E-38)
            int[] r3 = new int[]{r3}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE = r3
            r3 = 16843213(0x10101cd, float:2.369485E-38)
            int[] r1 = new int[]{r1, r3}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = r1
            int[] r0 = new int[r0]
            r0 = {x00d6: FILL_ARRAY_DATA , data: [16843073, 16843160, 16843198, 16843199, 16843200, 16843486, 16843487, 16843488} // fill-array
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATOR = r0
            r0 = 16843490(0x10102e2, float:2.3695626E-38)
            int[] r0 = new int[]{r0}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_ANIMATOR_SET = r0
            r0 = 16843486(0x10102de, float:2.3695615E-38)
            r1 = 16843487(0x10102df, float:2.3695618E-38)
            r3 = 16843488(0x10102e0, float:2.369562E-38)
            r4 = 16843489(0x10102e1, float:2.3695624E-38)
            int[] r0 = new int[]{r0, r1, r3, r4}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_PROPERTY_VALUES_HOLDER = r0
            r0 = 16842788(0x1010024, float:2.369366E-38)
            r1 = 16843992(0x10104d8, float:2.3697033E-38)
            r5 = 16843073(0x1010141, float:2.3694458E-38)
            int[] r0 = new int[]{r0, r5, r3, r1}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_KEYFRAME = r0
            r0 = 16843892(0x1010474, float:2.3696753E-38)
            r1 = 16843893(0x1010475, float:2.3696756E-38)
            int[] r0 = new int[]{r4, r2, r0, r1}
            androidx.vectordrawable.graphics.drawable.AndroidResources.STYLEABLE_PROPERTY_ANIMATOR = r0
            r0 = 16843774(0x10103fe, float:2.3696422E-38)
            r1 = 16843775(0x10103ff, float:2.3696425E-38)
            r3 = 16843772(0x10103fc, float:2.3696417E-38)
            r4 = 16843773(0x10103fd, float:2.369642E-38)
            int[] r0 = new int[]{r3, r4, r0, r1, r2}
