...
public final class SchedulerTaskKt {
    public static final void afterTask(kotlinx.coroutines.scheduling.TaskContext r1) {
            r0 = 0
            r1.afterTask()
            return
    }

    public static final kotlinx.coroutines.scheduling.TaskContext getTaskContext(kotlinx.coroutines.scheduling.Task r1) {
            kotlinx.coroutines.scheduling.TaskContext r0 = r1.taskContext
            return r0
    }

    public static /* synthetic */ void getTaskContext$annotations(kotlinx.coroutines.scheduling.Task r0) {
            return
    }
}
