...
public final class DeepRecursiveKt {
    ...
    public static final <T, R> R invoke(kotlin.DeepRecursiveFunction<T, R> r2, T r3) {
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            kotlin.DeepRecursiveScopeImpl r0 = new kotlin.DeepRecursiveScopeImpl
            kotlin.jvm.functions.Function3 r1 = r2.getBlock$kotlin_stdlib()
            r0.<init>(r1, r3)
            java.lang.Object r0 = r0.runCallLoop()
            return r0
    }
}
