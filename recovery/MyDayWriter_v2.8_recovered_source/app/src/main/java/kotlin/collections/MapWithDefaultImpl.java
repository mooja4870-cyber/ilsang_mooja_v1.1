...
final class MapWithDefaultImpl<K, V> implements kotlin.collections.MapWithDefault<K, V> {
    ...
    private final kotlin.jvm.functions.Function1<K, V> f1default;
    private final java.util.Map<K, V> map;

    public MapWithDefaultImpl(java.util.Map<K, ? extends V> r2, kotlin.jvm.functions.Function1<? super K, ? extends V> r3) {
            r1 = this;
    ...
    public V getOrImplicitDefault(K r6) {
            ...
            if (r3 != 0) goto L1a
            r3 = 0
            kotlin.jvm.functions.Function1<K, V> r4 = r5.f1default
