...
public final class FilteringSequence<T> implements kotlin.sequences.Sequence<T> {
    ...
    public static final class AnonymousClass1 implements java.util.Iterator<T>, kotlin.jvm.internal.markers.KMappedMarker {
        ...
        AnonymousClass1(kotlin.sequences.FilteringSequence<T> r2) {
                r1 = this;
                r1.this$0 = r2
                r1.<init>()
                kotlin.sequences.Sequence r0 = kotlin.sequences.FilteringSequence.access$getSequence$p(r2)
    ...
    public FilteringSequence(kotlin.sequences.Sequence<? extends T> r2, boolean r3, kotlin.jvm.functions.Function1<? super T, java.lang.Boolean> r4) {
            r1 = this;
    ...
    public /* synthetic */ FilteringSequence(kotlin.sequences.Sequence r1, boolean r2, kotlin.jvm.functions.Function1 r3, int r4, kotlin.jvm.internal.DefaultConstructorMarker r5) {
            r0 = this;
            r4 = r4 & 2
            if (r4 == 0) goto L5
            r2 = 1
    ...
    public static final /* synthetic */ kotlin.jvm.functions.Function1 access$getPredicate$p(kotlin.sequences.FilteringSequence r1) {
            kotlin.jvm.functions.Function1<T, java.lang.Boolean> r0 = r1.predicate
            return r0
    }

    public static final /* synthetic */ boolean access$getSendWhen$p(kotlin.sequences.FilteringSequence r1) {
            boolean r0 = r1.sendWhen
            return r0
    }

    public static final /* synthetic */ kotlin.sequences.Sequence access$getSequence$p(kotlin.sequences.FilteringSequence r1) {
    ...
    public java.util.Iterator<T> iterator() {
            r1 = this;
            kotlin.sequences.FilteringSequence$iterator$1 r0 = new kotlin.sequences.FilteringSequence$iterator$1
            r0.<init>(r1)
