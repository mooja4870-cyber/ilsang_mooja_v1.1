...
public final class LateinitKt {
    private static final boolean isInitialized(kotlin.reflect.KProperty0<?> r2) {
            java.lang.String r0 = "<this>"
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r2, r0)
            kotlin.NotImplementedError r0 = new kotlin.NotImplementedError
            java.lang.String r1 = "Implementation is intrinsic"
            r0.<init>(r1)
            throw r0
    }

    public static /* synthetic */ void isInitialized$annotations(kotlin.reflect.KProperty0 r0) {
            return
    }
}
